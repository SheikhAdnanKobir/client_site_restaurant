...
import LottieLodding from "../assets/LottieLoading.json"
...
const Allfoods = () => {
    ...
    useEffect(() => {
        fetch(`https://server-site-restaurant.vercel.app/datacount`)
            .then(res => res.json())
            .then(data => {
    ...
    useEffect(() => {
        ...
        const interval = setInterval(fatchData, 2000); // Fetch data every 2 second
        ...
        <div className='w-[95%] mx-auto'>
            ...
            </div>
            {
                loading ?
                    ...
                    <div className="h-screen flex flex-col items-center text-center px-4">
                        <Lottie
                            animationData={LottieLodding}
                            loop={true}
                            className="w-40 h-40 mb-6 opacity-80"
                        >
                        </Lottie>
                        <h2 className="text-4xl font-bold text-gray-700 mb-2">Loading...</h2>
                        <p className="text-lg text-gray-500 mb-6">Please wait while we fetch the data.</p>
                    </div>
            }
        </div>
    );
